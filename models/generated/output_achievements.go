...
func (q outputAchievementQuery) One(ctx context.Context, exec boil.ContextExecutor) (*OutputAchievement, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "generated: failed to execute a one query for output_achievements")
	}
...
func (q outputAchievementQuery) All(ctx context.Context, exec boil.ContextExecutor) (OutputAchievementSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "generated: failed to assign all query results to OutputAchievement slice")
	}
...
func (q outputAchievementQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to count output_achievements rows")
	}
...
func (q outputAchievementQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "generated: failed to check if output_achievements exists")
	}
...
func FindOutputAchievement(ctx context.Context, exec boil.ContextExecutor, outputAchievementID int, selectCols ...string) (*OutputAchievement, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "generated: unable to select from output_achievements")
	}
...
func (o *OutputAchievement) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("generated: no output_achievements provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to insert into output_achievements")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to populate default values for output_achievements")
	}
...
func (o *OutputAchievement) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("generated: unable to update output_achievements, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update output_achievements row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by update for output_achievements")
	}
...
func (q outputAchievementQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update all for output_achievements")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to retrieve rows affected for output_achievements")
	}
...
func (o OutputAchievementSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update all in outputAchievement slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to retrieve rows affected all in update all outputAchievement")
	}
	return rowsAff, nil
}
...
func (o *OutputAchievement) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("generated: no output_achievements provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("generated: unable to upsert output_achievements, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to upsert for output_achievements")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to retrieve unique values for output_achievements")
	}
...
func (o *OutputAchievement) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("generated: no OutputAchievement provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete from output_achievements")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by delete for output_achievements")
	}
...
func (q outputAchievementQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("generated: no outputAchievementQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete all from output_achievements")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by deleteall for output_achievements")
	}
...
func (o OutputAchievementSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete all from outputAchievement slice")
	}
...
func (o *OutputAchievementSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to reload all in OutputAchievementSlice")
	}
...
func OutputAchievementExists(ctx context.Context, exec boil.ContextExecutor, outputAchievementID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "generated: unable to check if output_achievements exists")
	}
