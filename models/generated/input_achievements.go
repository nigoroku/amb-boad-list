...
func (q inputAchievementQuery) One(ctx context.Context, exec boil.ContextExecutor) (*InputAchievement, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "generated: failed to execute a one query for input_achievements")
	}
...
func (q inputAchievementQuery) All(ctx context.Context, exec boil.ContextExecutor) (InputAchievementSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "generated: failed to assign all query results to InputAchievement slice")
	}
...
func (q inputAchievementQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to count input_achievements rows")
	}
...
func (q inputAchievementQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "generated: failed to check if input_achievements exists")
	}
...
func (o *InputAchievement) InputAchievementActions(mods ...qm.QueryMod) inputAchievementActionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`input_achievement_actions`.`input_achievement_id`=?", o.InputAchievementID),
	)
...
func (inputAchievementL) LoadInputAchievementActions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeInputAchievement interface{}, mods queries.Applicator) error {
	var slice []*InputAchievement
	var object *InputAchievement
	...
	query := NewQuery(qm.From(`input_achievement_actions`), qm.WhereIn(`input_achievement_actions.input_achievement_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *InputAchievement) AddInputAchievementActions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*InputAchievementAction) error {
	var err error
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.InputAchievementID, rel.InputAchievementActionID}
...
func FindInputAchievement(ctx context.Context, exec boil.ContextExecutor, inputAchievementID int, selectCols ...string) (*InputAchievement, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "generated: unable to select from input_achievements")
	}
...
func (o *InputAchievement) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("generated: no input_achievements provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to insert into input_achievements")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to populate default values for input_achievements")
	}
...
func (o *InputAchievement) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("generated: unable to update input_achievements, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update input_achievements row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by update for input_achievements")
	}
...
func (q inputAchievementQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update all for input_achievements")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to retrieve rows affected for input_achievements")
	}
...
func (o InputAchievementSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update all in inputAchievement slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to retrieve rows affected all in update all inputAchievement")
	}
	return rowsAff, nil
}
...
func (o *InputAchievement) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("generated: no input_achievements provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("generated: unable to upsert input_achievements, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to upsert for input_achievements")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to retrieve unique values for input_achievements")
	}
...
func (o *InputAchievement) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("generated: no InputAchievement provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete from input_achievements")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by delete for input_achievements")
	}
...
func (q inputAchievementQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("generated: no inputAchievementQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete all from input_achievements")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by deleteall for input_achievements")
	}
...
func (o InputAchievementSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete all from inputAchievement slice")
	}
...
func (o *InputAchievementSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to reload all in InputAchievementSlice")
	}
...
func InputAchievementExists(ctx context.Context, exec boil.ContextExecutor, inputAchievementID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "generated: unable to check if input_achievements exists")
	}
