...
var (
	userDBTypes = map[string]string{`UserID`: `int`, `AccountName`: `varchar`, `Email`: `varchar`, `Password`: `varchar`, `Role`: `tinyint`, `LastLoginAt`: `timestamp`, `CreatedBy`: `int`, `CreatedAt`: `timestamp`, `ModifiedBy`: `int`, `ModifiedAt`: `timestamp`, `AccountImg`: `blob`, `Introduction`: `text`}
	_           = bytes.MinRead
)
