...
func (q outputAchievementTagQuery) One(ctx context.Context, exec boil.ContextExecutor) (*OutputAchievementTag, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "generated: failed to execute a one query for output_achievement_tags")
	}
...
func (q outputAchievementTagQuery) All(ctx context.Context, exec boil.ContextExecutor) (OutputAchievementTagSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "generated: failed to assign all query results to OutputAchievementTag slice")
	}
...
func (q outputAchievementTagQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to count output_achievement_tags rows")
	}
...
func (q outputAchievementTagQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "generated: failed to check if output_achievement_tags exists")
	}
...
func FindOutputAchievementTag(ctx context.Context, exec boil.ContextExecutor, outputAchievementTagID int, selectCols ...string) (*OutputAchievementTag, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "generated: unable to select from output_achievement_tags")
	}
...
func (o *OutputAchievementTag) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("generated: no output_achievement_tags provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to insert into output_achievement_tags")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to populate default values for output_achievement_tags")
	}
...
func (o *OutputAchievementTag) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("generated: unable to update output_achievement_tags, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update output_achievement_tags row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by update for output_achievement_tags")
	}
...
func (q outputAchievementTagQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update all for output_achievement_tags")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to retrieve rows affected for output_achievement_tags")
	}
...
func (o OutputAchievementTagSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update all in outputAchievementTag slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to retrieve rows affected all in update all outputAchievementTag")
	}
	return rowsAff, nil
}
...
func (o *OutputAchievementTag) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("generated: no output_achievement_tags provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("generated: unable to upsert output_achievement_tags, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to upsert for output_achievement_tags")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to retrieve unique values for output_achievement_tags")
	}
...
func (o *OutputAchievementTag) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("generated: no OutputAchievementTag provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete from output_achievement_tags")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by delete for output_achievement_tags")
	}
...
func (q outputAchievementTagQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("generated: no outputAchievementTagQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete all from output_achievement_tags")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by deleteall for output_achievement_tags")
	}
...
func (o OutputAchievementTagSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete all from outputAchievementTag slice")
	}
...
func (o *OutputAchievementTagSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to reload all in OutputAchievementTagSlice")
	}
...
func OutputAchievementTagExists(ctx context.Context, exec boil.ContextExecutor, outputAchievementTagID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "generated: unable to check if output_achievement_tags exists")
	}
