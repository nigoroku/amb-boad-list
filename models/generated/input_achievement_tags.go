...
func (q inputAchievementTagQuery) One(ctx context.Context, exec boil.ContextExecutor) (*InputAchievementTag, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "generated: failed to execute a one query for input_achievement_tags")
	}
...
func (q inputAchievementTagQuery) All(ctx context.Context, exec boil.ContextExecutor) (InputAchievementTagSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "generated: failed to assign all query results to InputAchievementTag slice")
	}
...
func (q inputAchievementTagQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to count input_achievement_tags rows")
	}
...
func (q inputAchievementTagQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "generated: failed to check if input_achievement_tags exists")
	}
...
func FindInputAchievementTag(ctx context.Context, exec boil.ContextExecutor, inputAchievementTagID int, selectCols ...string) (*InputAchievementTag, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "generated: unable to select from input_achievement_tags")
	}
...
func (o *InputAchievementTag) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("generated: no input_achievement_tags provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to insert into input_achievement_tags")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to populate default values for input_achievement_tags")
	}
...
func (o *InputAchievementTag) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("generated: unable to update input_achievement_tags, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update input_achievement_tags row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by update for input_achievement_tags")
	}
...
func (q inputAchievementTagQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update all for input_achievement_tags")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to retrieve rows affected for input_achievement_tags")
	}
...
func (o InputAchievementTagSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to update all in inputAchievementTag slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to retrieve rows affected all in update all inputAchievementTag")
	}
	return rowsAff, nil
}
...
func (o *InputAchievementTag) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("generated: no input_achievement_tags provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("generated: unable to upsert input_achievement_tags, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to upsert for input_achievement_tags")
	}
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to retrieve unique values for input_achievement_tags")
	}
...
func (o *InputAchievementTag) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("generated: no InputAchievementTag provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete from input_achievement_tags")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by delete for input_achievement_tags")
	}
...
func (q inputAchievementTagQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("generated: no inputAchievementTagQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete all from input_achievement_tags")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "generated: failed to get rows affected by deleteall for input_achievement_tags")
	}
...
func (o InputAchievementTagSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "generated: unable to delete all from inputAchievementTag slice")
	}
...
func (o *InputAchievementTagSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "generated: unable to reload all in InputAchievementTagSlice")
	}
...
func InputAchievementTagExists(ctx context.Context, exec boil.ContextExecutor, inputAchievementTagID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "generated: unable to check if input_achievement_tags exists")
	}
